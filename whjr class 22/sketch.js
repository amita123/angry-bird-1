...
function setup() {
  ...
  var options = {
   ...
   catapult = Matter.Constraint.create(options);
   Matter.World.add(tomato,catapult); 
}
...
function draw() {
  ...
  strokeWeight(3);
  stroke ("black");
  line (bird.body.position.x, bird.body.position.y, log5.body.position.x, log5.body.position.y);
  pop ();
}